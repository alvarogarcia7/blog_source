...
url: /blog/2016/03/31/books-read-in-2016q1/
---
 ...
 * [Structure and Interpretation of Computer Programs](http://mitpress.mit.edu/sicp/) by Abelson, Sussman, and Sussman, with the '[@deAprendices][deaprendices]'s reading club'. Blog posts under the tag [sicp](/{{< category "sicp" >}}/). Only chapters 1 and 2.

[^1]:  The ending date of the quarter is the same as the publication date

Books started, not yet finished (WIP):

  * Building microservices, by Sam Newman, with the '[@deAprendices][deaprendices]'s reading club'. Blog posts under the tag [building-microservices](/{{< category "building-microservices" >}}/)
