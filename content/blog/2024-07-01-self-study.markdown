...
- architecture-decisional-record
- argument
- asicsp
- assessment
- attack
...
## [Rust by example: variadics](https://doc.rust-lang.org/rust-by-example/macros/variadics.html)
...
## [Real-time audio programming 101: time waits for nothing (2011)](http://www.rossbencina.com/code/real-time-audio-programming-101-time-waits-for-nothing)
...
## [Radius/UDP. How legacy protocols need to keep up with modern cryptography](https://blog.cloudflare.com/radius-udp-vulnerable-md5-attack)
...
1. interfacing with reference managers
2. exporting/publishing with LaTeX/pandoc.
...
## [Data Fetching for Single-Page Apps](https://martinfowler.com/articles/data-fetch-spa.html)
...
## [Using Rust to corrode insane Python run-times (2021)](https://www.vortexa.com/product-blog/using-rust-to-corrode-insane-python-run-times/)
...
## [DCS sues Small YouTuber for accurate product review [video]](https://www.youtube.com/watch?v=_QNMVMlx48E)
...
## [Boost Productivity With Emacs, Org Mode and Org Agenda](https://m.youtube.com/watch?v=Ea_-TaEGa7Y)
...
## [OpenSSL bug exposed up to 255 bytes of client heap and existed since 2011](https://jbp.io/2024/06/27/cve-2024-5535-openssl-memory-safety.html)
